...
public:
  ...
  bool addResource(const std::string &name,
                   const std::string &added_resource_path);
   ...
   * @param name Resource name
   * @return optional containing resource information or std::nullopt if it
   * doesn't exist
   */
   ...
   * @param name Resource name
   * @return optional containing the path or std::nullopt if resource doesn't
   * exist
   */
