 ...
 *
 * Provides TCP server functionality for handling incoming resource download requests.
 * Implements resource sending according to the protocol specification.
 * Handles resource requests with offsets for resuming interrupted transfers.
 */
class TcpServer {
public:
    /**
     * @brief Constructs the TCP server with specified resource manager and default settings
     * @param resource_manager The resource manager to handle resource requests
     * @param port The port to listen on (default: 8080)
     * @param max_clients Maximum number of queued client connections (default: 10)
     */
