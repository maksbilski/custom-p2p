...
namespace announcement_broadcaster {
    static constexpr std::chrono::seconds DEFAULT_BROADCAST_INTERVAL{30000};
...
namespace tcp_server {
    ...
    static constexpr size_t BUFFER_SIZE = 4096;
    static constexpr std::chrono::milliseconds MAIN_LOOP_DELAY_MS = std::chrono::milliseconds(2000);
